...
def upload_raw():
    print("Inicio de la subida de la capa RAW")
    source_path = 'resultados/raw/'
    db = Connect()
    db.dump_data(schema_name='SCHEME_RAW', directory=source_path)
    print("Capa subida")

def upload_silver():
    print("Inicio de la subida de la capa SILVER")
    source_path = 'resultados/silver/'
    db = Connect()
    db.dump_data(schema_name='SCHEME_SILVER', directory=source_path)
    print("Capa subida")

def upload_gold():
    print("Inicio de la subida de la capa GOLD")
    source_path = 'resultados/gold/'
    db = Connect()
    db.dump_data(schema_name='SCHEME_GOLD', directory=source_path)
    print("Capa subida")
